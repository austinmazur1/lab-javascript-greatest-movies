...
/*"TODO"
- use the .map method to loop through movies array
...
/* "TODO 
- use .filter() method to loop 
- use a conditional to see if Spielberg & if its a drama
- return a number
...
/*"TODO 
- use reduce to add up all the movie scores
